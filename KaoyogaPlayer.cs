...
public class KaoyogaPlayer : MonoBehaviour
{
	...
	void Update()
	{
		...
		if (stage == 2)
		{
			if (currentBlendShapes["cheekPuff"] >= 0.2 && (currentBlendShapes["mouthFrown_R"] >= 0.3 || currentBlendShapes["mouthDimple_R"] >= 0.1))
			{
				hugugao_R = true;
				countup += Time.deltaTime;
			}
		...
		if (stage == 3)
		{
			if (currentBlendShapes["cheekPuff"] >= 0.2 && (currentBlendShapes["mouthFrown_L"] >= 0.3 || currentBlendShapes["mouthDimple_L"] >= 0.1))
			{
				hugugao_L = true;
				countup += Time.deltaTime;
			}
